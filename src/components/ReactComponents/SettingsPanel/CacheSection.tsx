  ...
  return (
    <>
      ...
      {r1 && (
        ...
        >
          <button className="il-sp-btn" onClick={() => RemoveCurrentLyrics_AllCaches(true)}>
            Clear
          </button>
        </Row>
      )}
      ...
      {r2 && (
        <Row label="Clear Stored Lyrics Cache" description="Delete lyrics that have been cached for up to 3 days.">
          <button className="il-sp-btn" onClick={() => RemoveLyricsCache(true)}>
            Clear Cache
          </button>
        </Row>
      )}
      ...
      {r3 && (
        ...
        >
          <button className="il-sp-btn" onClick={() => RemoveCurrentLyrics_StateCache(true)}>
            Clear State
          </button>
        </Row>
      )}
