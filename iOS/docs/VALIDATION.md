...
- Build/packaging verification: 32 Python tests, reproducible Xcode project generation, Bash syntax, and inspection of the real Spotify SDK device binary. Simulator binaries, truncated/encrypted binaries, broken library dependencies, raised minimum OS versions, and incomplete test evidence are rejected.
