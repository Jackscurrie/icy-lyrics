...
4. Resolve the [distribution review](docs/DISTRIBUTION.md) before making an SDK-containing binary public. The workflow uploads reports by default; `ICY_IOS_BINARY_DISTRIBUTION_CLEARED=true` additionally enables IPA artifact upload after successful builds. It never publishes a GitHub Release automatically.
