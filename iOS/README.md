...
**Status: source port implemented; the simulator suite and device packaging pass, and a validated unsigned IPA is available for owner testing.** See [validation status](docs/VALIDATION.md). Run [33877791410](https://github.com/Jackscurrie/icy-lyrics/actions/runs/33877791410) passed the desktop, Android and iPhone jobs at revision `e60fb87`; the locally recovered owner delivery is labelled **“simulator-verified IPA; physical iPhone validation pending.”** All 20 archived Android portrait and landscape scenarios still match the original pixel-for-pixel after extraction. The iPhone captures do not yet match those Android references, so Android-identical appearance and physical-iPhone behavior remain acceptance requirements.
